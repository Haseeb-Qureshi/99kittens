...
Cat.create!(name: 'Spinkles', sex: 'F', birth_date: 65.months.ago, color: 'calico', user_id: 1)
...
CatRentalRequest.create!(cat_id: 1, start_date: 12.days.ago, end_date: 8.days.ago, status: 'APPROVED', user_id: 1)
CatRentalRequest.create!(cat_id: 1, start_date: 5.days.ago, end_date: 4.days.ago, status: 'DENIED', user_id: 1)
